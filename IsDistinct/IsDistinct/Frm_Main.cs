...
namespace IsDistinct
{
    public partial class Frm_Main : Form
    {
        ...
        //连接数据库的字符串
        string connstr = @"Provider=SQLOLEDB;Data Source=dell; uid=sa;pwd=sa;Persist Security Info=False;Initial Catalog= Test";
        ...
        {
            if (isHomologyNote("Basic", "Number", "Name", textBox1.Text, textBox2.Text) > 0)//如果查询结果大于0
